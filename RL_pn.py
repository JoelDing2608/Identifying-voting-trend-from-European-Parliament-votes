...
dfx = pd.read_csv("indice_party.csv", delimiter=';')  # Utiliser le fichier Pays.csv comme variables explicatives
...
# Charger les données
dfx = pd.read_csv("indice_party.csv", delimiter=';')  # Variables explicatives
