...
dfx = pd.read_csv("indice_country.csv", delimiter=';')  # Utiliser le fichier Pays.csv comme variables explicatives
...
# Charger les données
dfx = pd.read_csv("indice_country.csv", delimiter=';')  # Variables explicatives
