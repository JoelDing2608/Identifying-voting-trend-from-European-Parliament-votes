...
dfx = pd.read_csv("indice_epg.csv", delimiter=';')  # Utiliser le fichier Pays.csv comme variables explicatives
...
# Charger les données
dfx = pd.read_csv("indice_epg.csv", delimiter=';')  # Variables explicatives
